<div class="text-center">
    ...
    <div>
        <div>
            <img src="<?= URL; ?>public/Assets/images/<?= $utilisateur['image'] ?>" width="100px"
                alt="photo de profil" />
        </div>
    ...
    <div id="suppressionCompte" class="d-none m-2">
        <div class="alert alert-danger">
            ...
            <br />
            <a href="<?= URL ?>compte/suppressionCompte" class="btn btn-danger">Je Souhaite supprimer mon compte
                définitivement !</a>
        </div>
    </div>
</div>